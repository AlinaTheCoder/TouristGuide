      ...
      <View style={styles.imageContainer}>
        ...
        <View style={styles.topIconsContainer}>
          <TouchableOpacity style={styles.iconButton} onPress={() => navigation.goBack()}>
            <Image source={require("../icons/back.png")} style={styles.iconImage} />
          </TouchableOpacity>
        </View>
    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View>
          ...
          <Text style={styles.subTitle}>{activityData.address}</Text>
          ...
          <Text style={styles.subTitle}>Rs {activityData.pricePerGuest} per Guest</Text>
        ...
        <View style={styles.descriptionContainer}>
          ...
          <Text style={styles.descriptionText}>
            {isExpanded
              ...
              : `${(activityData.locationDescription || "No location description provided").slice(
                  0,
                  100
                )}`}
            {!isExpanded &&
        ...
        <View>
          ...
          <View style={styles.infoRow}>
            <Text style={styles.InfoSubtitle}>
              Phone No: {activityData.phoneNumber}
            </Text>
            <TouchableOpacity
...
export default HostActivityDetails;
