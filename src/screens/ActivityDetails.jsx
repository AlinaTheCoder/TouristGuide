      ...
      <View style={styles.imageContainer}>
        ...
        <View style={styles.topIconsContainer}>
          <TouchableOpacity
            ...
            onPress={() => {
              const from = route.params?.from || 'Explore'; // Default to Explore if not specified
              
              if (from === 'AfterSearch') {
                // Preserve all the search parameters when navigating back
                const searchParams = route.params?.searchParams || {};
                navigation.navigate('AfterSearch', searchParams);
              } else {
                // For tabs inside UserTabs (Explore, Wishlists, etc.)
                navigation.navigate('UserTabs', { screen: from });
              }
            }}
          >
            <Image
